...
app.listen(settings.PORT, "0.0.0.0", () => {
    ...
    console.log(`manifestRetries=${settings.HLS_MANIFEST_RETRIES} manifestHold=${settings.HLS_MANIFEST_STABILITY_HOLD_MS / 1000}s edgeBatch=${settings.HLS_LIVE_EDGE_BATCH_SEGMENTS}/${settings.HLS_LIVE_EDGE_BATCH_HOLD_MS / 1000}s segmentRetries=${settings.SEGMENT_UPSTREAM_RETRIES}`);
...
function buildStats(configKey) {
    ...
    return {
        ...
        playback: {
            ...
            liveEdgeBatchSegments: settings.HLS_LIVE_EDGE_BATCH_SEGMENTS,
            liveEdgeBatchHoldMs: settings.HLS_LIVE_EDGE_BATCH_HOLD_MS,
