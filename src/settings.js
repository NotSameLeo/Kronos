...
module.exports = {
    ...
    TRANSCODE_PLAYBACK_DELAY_SECONDS: integerEnv("TRANSCODE_PLAYBACK_DELAY_SECONDS", 180, 0, 600),
    TRANSCODE_PLAYLIST_WINDOW_SEGMENTS: integerEnv("TRANSCODE_PLAYLIST_WINDOW_SEGMENTS", 45, 3, 120),
    TRANSCODE_START_TIMEOUT_MS: numberEnv("TRANSCODE_START_TIMEOUT_MS", 300000, 1000),
