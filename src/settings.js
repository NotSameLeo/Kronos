...
module.exports = {
    ...
    TRANSCODE_SOURCE_VIDEO_BITRATE_K: numberEnv("TRANSCODE_SOURCE_VIDEO_BITRATE_K", 5000, 1000, 20000),
    TRANSCODE_SOURCE_AUDIO_BITRATE_K: numberEnv("TRANSCODE_SOURCE_AUDIO_BITRATE_K", 128, 32, 320),
    TRANSCODE_SOURCE_BANDWIDTH: numberEnv("TRANSCODE_SOURCE_BANDWIDTH", 7000000, 1000000),
    TRANSCODE_SOURCE_AVERAGE_BANDWIDTH: numberEnv("TRANSCODE_SOURCE_AVERAGE_BANDWIDTH", 5128000, 1000000),
