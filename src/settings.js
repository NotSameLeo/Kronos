...
module.exports = {
    ...
    HLS_MANIFEST_STABILITY_HOLD_MS: numberEnv("HLS_MANIFEST_STABILITY_HOLD_MS", 45000, 0),
    HLS_MANIFEST_STABILITY_RETRY_DELAY_MS: numberEnv("HLS_MANIFEST_STABILITY_RETRY_DELAY_MS", 2000, 250),
    HLS_MANIFEST_STABILITY_HISTORY_MS: numberEnv("HLS_MANIFEST_STABILITY_HISTORY_MS", 120000, 1000),
    ...
    TS_LIVE_RECONNECT_DELAY_MS: numberEnv("TS_LIVE_RECONNECT_DELAY_MS", 150, 0),
    TS_LIVE_ERROR_RETRY_MS: numberEnv("TS_LIVE_ERROR_RETRY_MS", 1000, 0),
    SEGMENT_TOKEN_HEALING: String(process.env.SEGMENT_TOKEN_HEALING || "0") === "1",
    ...
    HLS_LIVE_EDGE_DELAY_SECONDS: numberEnv("HLS_LIVE_EDGE_DELAY_SECONDS", 30, 0),
    HLS_LIVE_EDGE_MIN_SEGMENTS: numberEnv("HLS_LIVE_EDGE_MIN_SEGMENTS", 3, 1),
    HLS_LIVE_EDGE_BATCH_SEGMENTS: numberEnv("HLS_LIVE_EDGE_BATCH_SEGMENTS", 2, 1, 4),
    HLS_LIVE_EDGE_BATCH_HOLD_MS: numberEnv("HLS_LIVE_EDGE_BATCH_HOLD_MS", 22000, 0),
