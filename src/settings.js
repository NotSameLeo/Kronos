...
module.exports = {
    ...
    TRANSCODE_HLS_DELETE_THRESHOLD: numberEnv("TRANSCODE_HLS_DELETE_THRESHOLD", 12, 4, 60),
    ...
    TRANSCODE_BLACK_GUARD_MIN_SEGMENTS: numberEnv("TRANSCODE_BLACK_GUARD_MIN_SEGMENTS", 2, 1, 6),
